    ...
    <header className="w-full sticky top-0 z-40 backdrop-blur border-b border-white/10 bg-black/30">
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center gap-3">
        ...
        <nav className="ml-auto flex items-center gap-6 text-sm">
          ...
          <Link href="/spotlight" className="text-white/80 hover:text-white">
            Spotlight
          </Link>
          ...
          <Link
            href="/plans"
            className="px-3 py-1.5 rounded-full bg-violet-600 hover:bg-violet-500 text-white font-semibold"
          >
            Upgrade
          </Link>
        </nav>
