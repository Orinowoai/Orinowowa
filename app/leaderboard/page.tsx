...
export default function Leaderboard() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-14">
      <h1 className="text-4xl font-bold text-luxuryGold">Orinowo Global Leaderboard</h1>
      <p className="opacity-80">Prize pool • brand partnerships • discoverability</p>
      <div className="mt-6">
        <BarChart rows={rows} />
      </div>
      <div className="card mt-10">
        <h3 className="text-2xl font-bold text-luxuryGold">Countdown to Artist/Producer of the Year</h3>
